...
function Sidebar() {
  return (
    <div className='sticky top-0 col-span-1 w-[72%] justify-between flex flex-col h-screen text-sm border-r-[.5px] border-r-gray-200 bg-white'>
       <div className='ml-2'>
       <img className='mt-9 ml-3 w-[50%]' src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Instagram_logo.svg/840px-Instagram_logo.svg.png " />
